    ...
    <div class="container bg-white rounded p-4">
        <div class="d-flex">
            <div class="me-auto p-2">
                <a href="{{ url('/dashboard') }}" class="btn border">
                    <i class="ri-arrow-go-back-line fs-5"></i>
                </a>
            </div>
            <div class="p-2">
                <a href="{{ route('export.pdb', $dataPdb->id) }}" class="btn border">
        ...
        <div class="border rounded p-3 position-relative mb-4">
            ...
            <div class="mb-2 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="tempat_lahir" id="tempat_lahir" value="{{ old('tempat_lahir', $dataPdb->tempat_lahir) }}" class="form-control" required>
                </div>
            </div>
            <div class="mb-2 row">
                ...
                <div class="col-sm-10">
                    <select name="agama" id="agama" class="form-select" required>
                        <option value="{{ old('agama', $dataPdb->agama) }}" hidden selected>{{ $dataPdb->agama }}</option>
